...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/EditPost/index.vue?vue&type=template&id=0922983a&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.pageLoading)?_c('div',{staticClass:"spinner-border",attrs:{"role":"status"}},[_vm._ssrNode("<span class=\"visually-hidden\">Loading...</span>")],2):_c('div',{staticClass:"col-md-6"},[_vm._ssrNode("<h2 class=\"mb-5\">Edit Post :</h2> "),_c('PostForm',{attrs:{"button-loading":_vm.loading,"button-text":"Edit Post","post":_vm.post},on:{"formData":_vm.updatePost}})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/EditPost/index.vue?vue&type=template&id=0922983a&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/EditPost/index.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var EditPostvue_type_script_lang_js_ = ({
  name: 'EditPost',
  ...
  methods: {
    ...
    updatePost(formData) {
      if (formData.title === this.post.title && formData.body === this.post.body) {
        return alert("nothing is change");
      }

      this.loading = true; // console.log(formData.title , post.value.title){}
...
// CONCATENATED MODULE: ./pages/EditPost/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_EditPostvue_type_script_lang_js_ = (EditPostvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/EditPost/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_EditPostvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var EditPost = __webpack_exports__["default"] = (component.exports);
